...
// Pipeline resolver: functions/verifyChildOwnership.ts -> functions/prepareAttempt.ts
...
export const pipelineFunctions = ['verifyChildOwnership', 'prepareAttempt', 'recordAttempt'];
